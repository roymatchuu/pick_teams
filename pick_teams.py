...
def main():
    ...
    # List of 15 possible
    inp = "Gail,Julienne,Bernice,Hansel,Viv,Daniel,Ate Che,Pablo,Mirielle,Brielle,Angelo,JRey,PJ,Troy,Iz"
    people = parse_list_of_people(inp)
    groups = create_teams(people)
    print_teams(groups)

# Julienne,Matthew,JRey,Abi,Pablo
